...
describe('Out', () => {
	...
	it('should have a method logLevel()', () => expect(typeof instance.logLevel).toBe('function'))
	it('should have a method verbosity()', () => expect(typeof instance.log_level).toBe('function'))
	it('should have a method v()', () => expect(typeof instance.v).toBe('function'))
	it('should have a method shouldOutput()', () => expect(typeof instance.shouldOutput).toBe('function'))
	it('should have a method getLogLevel()', () => expect(typeof instance.getLogLevel).toBe('function'))
	it('should have a method getEnvLogLevel()', () => expect(typeof instance.getEnvLogLevel).toBe('function'))
	it('should have a method setEnvLogLevel()', () => expect(typeof instance.setEnvLogLevel).toBe('function'))
	...
	it('should have a method extraLogLevel()', () => expect(typeof instance.extraLogLevel).toBe('function'))
